const CACHE_NAME='valet-radio-hq-shell-v6';
const STATIC_SHELL=['/','/index.html','/styles.css','/manifest.webmanifest','/src/app.js','/src/api.js','/src/config.js','/src/permissions.js','/src/scanner.js','/src/state.js','/src/supabase-client.js','/src/view-models.js','/src/reset-password.js','/auth/reset-password.html','/icons/icon-192.png','/icons/icon-512.png','/icons/apple-touch-icon.png','/branding/valet-radio-hq-logo.png','/branding/valet-radio-hq-mark.png','/branding/favicon-64.png'];
