const CACHE_NAME='radioops-shell-v1';
const STATIC_SHELL=['/','/index.html','/styles.css','/manifest.webmanifest','/src/app.js','/src/api.js','/src/config.js','/src/permissions.js','/src/scanner.js','/src/state.js','/src/supabase-client.js','/src/view-models.js','/icons/icon-192.png','/icons/icon-512.png','/icons/apple-touch-icon.png'];
...
self.addEventListener('fetch',event=>{
  ...
  if(!STATIC_SHELL.includes(url.pathname) && url.pathname!=='/auth/callback' && url.pathname!=='/auth/callback.html') return;
