...
test('DYMO 30336 label XML contains radio id, QR type, and secure token',()=>{
...
test('DYMO filenames are stable and radio-specific',()=>{
  ...
  assert.equal(dymoFilename('wt-40'),'Valet-Radio-HQ-WT-40-QR-30336.label');
});
